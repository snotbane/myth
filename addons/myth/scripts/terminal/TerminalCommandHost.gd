...
func _init() -> void:
	...
	create_command(&"screenshot", command_screenshot, 1, true, "Creates a screenshot of the root viewport.")
...
func command_screenshot():
	MythPlugin.save_viewport_to_image(get_tree().root.get_viewport())
